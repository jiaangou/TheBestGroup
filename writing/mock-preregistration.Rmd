...
bibliography: 'prod-reprod-class-assignment-2.bib' # from Zotero, see below
csl: freshwater-biology.csl # sets up citation style

output: prereg::cos_prereg # determines output type and format
---
...
NOTE: to knit using a bib file, you will need to install a different version of `prereg` using
`remotes::install_github("crsh/prereg@issue-16")`. not sure why this happens. -- Stefano
