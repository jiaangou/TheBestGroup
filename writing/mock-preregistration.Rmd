...
Surface sediment samples (0-1cm) will be collected using a mini-Glew gravity coring apparatus [@glew1991] as was done in @gushulak2021. The surface sediment sampling will be along three depth transects in each of the basins of Gall Lake, to expand upon the area covered in @gushulak2021 and account for any differences in deposition to the surface sediments due to circulation patterns in Gall Lake.
